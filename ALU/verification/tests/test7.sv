...
initial begin : test_srl
    ...
    shift_amount = 8'd1;
    prepare_and_execute(value_a, shift_amount, SRL);
    check_transaction(value_a, shift_amount, SRL, "TEST7_SRL_EDGE");
    ...
    for (i = 0; i < 100; i = i + 1) begin
        ...
        prepare_and_execute(value_a, shift_amount, SRL);
        check_transaction(value_a, shift_amount, SRL, "TEST7_SRL_RANDOM");
    end
