...
`ifdef TEST5
// Test 5: Se verifica el funcionamiento de la operación XOR en la ALU.
initial begin : test_xor
    ...
    for (i = 0; i < 100; i = i + 1) begin
        ...
        prepare_and_execute(value_a, value_b, XOR);
        check_transaction(value_a, value_b, XOR, "TEST5_XOR");
    end
