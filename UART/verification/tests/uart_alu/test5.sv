...
`ifdef TEST5
// Test 5: Se verifica el funcionamiento de la operacion XOR en la UART-ALU.
initial begin : test_xor
    ...
    for (i = 0; i < 10; i = i + 1) begin
        ...
        run_alu_transaction(value_a, value_b, XOR);
        check_transaction(value_a, value_b, XOR, "TEST5_XOR_RANDOM");
    end
