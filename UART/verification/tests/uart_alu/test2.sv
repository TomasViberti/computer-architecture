...
`ifdef TEST2
// Test 2: Se verifica el funcionamiento de la operacion SUB en la UART-ALU.
initial begin : test_sub
    ...
    for (i = 0; i < 10; i = i + 1) begin
        ...
        run_alu_transaction(value_a, value_b, SUB);
        check_transaction(value_a, value_b, SUB, "TEST2_SUB_RANDOM");
    end
